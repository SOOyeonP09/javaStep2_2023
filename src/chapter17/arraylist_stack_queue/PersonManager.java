...
public class PersonManager {
	...
	public void personMgr() {
		...
		while (true) {
			...
			switch (select) {
			case 1: // 정보추가
				p = new Person();// 정보를 추가할 때마다 Person 객체
			...
			case 3:
				...
				/*
				for (int i = 0; i < personArr.size(); i++) {
					System.out.print("이름 : " + personArr.get(i).getName());
					System.out.print("나이 : " + personArr.get(i).getAge());
					System.out.print("번호 : " + personArr.get(i).getTel());
					System.out.print("-----------------------------");
				}
				*/
